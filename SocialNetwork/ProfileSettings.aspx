<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProfileSettings.aspx.cs" Inherits="SocialNetwork.ProfileSettings" %>
                    ...
                    <div class="row">
                        <div class="main-content animated fadeInLeft">
                            <ul class="nav nav-tabs nav-tabs-custom-colored tabs-iconized">
                                <li class="active"><a href="#profile-tab" data-toggle="tab" aria-expanded="true">
                                    <i class="fa fa-user"></i>Profile</a>
                                </li>
                                <li class=""><a href="#activity-tab" data-toggle="tab" aria-expanded="false">
                                    <i class="fa fa-rss"></i>Recent Activity</a>
                                </li>
                                <li class=""><a href="#settings-tab" data-toggle="tab" aria-expanded="false">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="user-info-left">
                                                <img src="img/Friends/woman-4.jpg" alt="Profile Picture">
                                                <h2>Katya Angintiew. <i class="fa fa-circle green-font online-icon"></i><sup class="sr-only">online</sup></h2>
                                                <div class="contact">
                                                    <a href="messages.html" class="btn btn-block btn-info"><i class="fa fa-envelope-o"></i>Send Message</a>
                                            ...
                                            <div class="user-info-right">
                                                ...
                                                <div class="contact_info">
                                                    ...
                                                    <p class="data-row">
                                                        ...
                                                        <span class="data-value">Riverside City 66, 80123 Denver<br>
                                                            Colorado</span>
                                                    </p>
                                                </div>
                                                <div class="about">
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <ul class="col-sm-7 list-inline">
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-on" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-globe"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-globe"></i></span><input type="checkbox" checked="" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-globe'></i>" data-off-label="<i class='fa fa-globe'></i>"></div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-on" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-phone"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-phone"></i></span><input type="checkbox" checked="" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-phone'></i>" data-off-label="<i class='fa fa-phone'></i>"></div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-on" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-envelope"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-envelope"></i></span><input type="checkbox" checked="" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-envelope'></i>" data-off-label="<i class='fa fa-envelope'></i>"></div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <ul class="col-sm-7 list-inline">
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-off" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-globe"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-globe"></i></span><input type="checkbox" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-globe'></i>" data-off-label="<i class='fa fa-globe'></i>"></div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-on" tabindex="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="col-sm-7 list-inline">
                                                    ...
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-off" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-phone"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-phone"></i></span><input type="checkbox" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-phone'></i>" data-off-label="<i class='fa fa-phone'></i>"></div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-on" tabindex="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="col-sm-7 list-inline">
                                                    ...
                                                    <li>
                                                        <div class="has-switch switch-animate switch-small switch-off" tabindex="0">
                                                            <div><span class="switch-left"><i class="fa fa-envelope"></i></span>
                                                                <label>&nbsp;</label><span class="switch-right switch-default"><i class="fa fa-envelope"></i></span><input type="checkbox" class="bs-switch switch-small" data-off="default" data-on-label="<i class='fa fa-envelope'></i>" data-off-label="<i class='fa fa-envelope'></i>"></div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
